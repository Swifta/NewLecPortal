...
/**
 * The persistent class for the ORGANISATION001 database table.
 * 
 */
@Entity
@NamedQuery(name="Organisation001.findAll", query="SELECT o FROM Organisation001 o")
public class Organisation001 implements Serializable {
