...
/**
 * The persistent class for the LOGIN001 database table.
 * 
 */
@Entity
@NamedQuery(name="Login001.findAll", query="SELECT l FROM Login001 l")
public class Login001 implements Serializable {
