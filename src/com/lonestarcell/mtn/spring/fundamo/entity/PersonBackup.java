...
/**
 * The persistent class for the PERSON_BACKUP database table.
 * 
 */
@Entity
@Table(name="PERSON_BACKUP")
@NamedQuery(name="PersonBackup.findAll", query="SELECT p FROM PersonBackup p")
