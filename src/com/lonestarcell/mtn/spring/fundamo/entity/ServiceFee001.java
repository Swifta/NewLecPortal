...
/**
 * The persistent class for the SERVICE_FEE001 database table.
 * 
 */
@Entity
@Table(name="SERVICE_FEE001")
@NamedQuery(name="ServiceFee001.findAll", query="SELECT s FROM ServiceFee001 s")
public class ServiceFee001 implements Serializable {
