...
/**
 * The persistent class for the MONEY_TRANS_REVERSED_280515 database table.
 * 
 */
// @Entity
@Table(name="MONEY_TRANS_REVERSED_280515")
@NamedQuery(name="MoneyTransReversed280515.findAll", query="SELECT m FROM MoneyTransReversed280515 m")
public class MoneyTransReversed280515 implements Serializable {
	...
	public MoneyTransReversed280515() {
	}
