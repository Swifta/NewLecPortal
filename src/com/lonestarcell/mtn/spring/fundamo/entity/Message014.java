...
/**
 * The persistent class for the MESSAGE014 database table.
 * 
 */
@Entity
@NamedQuery(name="Message014.findAll", query="SELECT m FROM Message014 m")
public class Message014 implements Serializable {
