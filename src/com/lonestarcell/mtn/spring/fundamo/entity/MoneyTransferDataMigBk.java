...
/**
 * The persistent class for the MONEY_TRANSFER_DATA_MIG_BK database table.
 * 
 */
@Entity
@Table(name="MONEY_TRANSFER_DATA_MIG_BK")
@NamedQuery(name="MoneyTransferDataMigBk.findAll", query="SELECT m FROM MoneyTransferDataMigBk m")
public class MoneyTransferDataMigBk implements Serializable {
