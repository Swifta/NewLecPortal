...
/**
 * The persistent class for the TRANSACTION_PENDING database table.
 * 
 */
// @Entity
@Table(name="TRANSACTION_PENDING")
@NamedQuery(name="TransactionPending.findAll", query="SELECT t FROM TransactionPending t")
