...
public class MultiRowActionsUITxn extends VerticalLayout implements DUIControllable, PopupView.Content {
	...
	public MultiRowActionsUITxn( MTxn mTxn, In in, Grid grid, PopupView popupView ){
