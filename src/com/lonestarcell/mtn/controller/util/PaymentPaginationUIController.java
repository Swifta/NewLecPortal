...
public class PaymentPaginationUIController implements DUIControllable, Serializable{
	...
	public PaymentPaginationUIController( BeanItemContainer<OutTxn> container, MTxn mTxn, InTxn inTxn ){
