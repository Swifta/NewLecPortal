...
public class DataExportUIInfo extends AbstractDDataExportUI<MTxn, OutTxn, In > implements DUIInitializable {

	private Logger log = LogManager.getLogger();
	public DataExportUIInfo( MTxn mTxn, In in, Collection<Item> records, VerticalLayout cMoreOps ){
	...
	protected  boolean setAllExportRecords( MTxn mTxn, In in, Collection<Item>records ){
		...
		Out out = mTxn.setExportDataMultiInfoToday(in, container, records );
