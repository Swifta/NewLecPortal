...
public class DataExportUIToken extends AbstractDDataExportUI<MTxn, OutTxn, In > implements DUIInitializable {

	private Logger log = LogManager.getLogger();
	public DataExportUIToken( MTxn mTxn, In in, Collection<Item> records, VerticalLayout cMoreOps ){
	...
	protected  boolean setAllExportRecords( MTxn mTxn, In in, Collection<Item>records ){
		...
		Out out = mTxn.setExportDataMultiTokenToday(in, container, records );
