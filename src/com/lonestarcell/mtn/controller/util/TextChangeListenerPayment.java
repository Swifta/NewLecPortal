...
public class TextChangeListenerPayment<O> implements TextChangeListener{
	...
	TextChangeListenerPayment( BeanItemContainer<O> container, InTxn inTxn,
	...
	public void textChange(TextChangeEvent event) {
		...
		}else if( itemId.equals( "token" ) ) {
			inTxn.setSearchToken( val );
		}else if( itemId.equals( "reqCurrency" ) ) {
			inTxn.setSearchReqCur( val );
		}
