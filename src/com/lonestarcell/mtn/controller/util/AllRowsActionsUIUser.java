...
public class AllRowsActionsUIUser
		extends
		AbstractAllRowsActionsUIUser<MUser, OutUser, TextChangeListenerUser<OutUser>> {
	...
	public AllRowsActionsUIUser(MUser mSub, Grid grid, In in,
	...
	protected void addFilterField(BeanItemContainer<OutUser> container,
		...
		TextChangeListenerUser<OutUser> tChangeListener = getTextChangeListner(
				container, itemId, tF);
	...
	protected void setBeanItemContainer() {
		container = ((BeanItemContainer<OutUser>) ((GeneratedPropertyContainer) grid
	...
	protected TextChangeListenerUser<OutUser> getTextChangeListner(
			BeanItemContainer<OutUser> container, String itemId,
			TextField tF) {
		return new TextChangeListenerUser<OutUser>(container, inTxn,
				itemId, tF);
	}
