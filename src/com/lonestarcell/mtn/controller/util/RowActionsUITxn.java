...
public class RowActionsUITxn extends VerticalLayout implements DUIControllable{
	
	private static final long serialVersionUID = 1L;
	private Button btnDetails;
	private Button btnRefresh;
	private Item record;
	private Logger log = LogManager.getLogger( RowActionsUITxn.class.getName() );
	private MTxn mTxn;
	
	public RowActionsUITxn( MTxn mTxn, Item record ){
		this.mTxn = mTxn;
		setRecord( record );
