...
public class MultiRowActionsUIPayment extends AbstractMultiRowActionsUI {
	
	private static final long serialVersionUID = 1L;
	
	public MultiRowActionsUIPayment(MTxn mTxn, In in, Grid grid,
			PopupView popupView) {
	...
	protected void attachBtnExport(){
		this.btnExport.addClickListener( new ClickListener(){
			...
			public void buttonClick(ClickEvent event) {
				...
				VerticalLayout v = new DataExportUIPayment( mTxn, in, records, new VerticalLayout() ).getcMoreOps();
				v.setWidth( "37px" );
	...
	protected void attachBtnRefresh(){
		this.btnRefresh.addClickListener( new ClickListener(){
			...
			public void buttonClick(ClickEvent event) {
				...
				Out out = mTxn.refreshMultiPaymentRecord( records );
