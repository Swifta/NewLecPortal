...
public class AllRowsActionsUISub extends AbstractAllRowsActionsUI<MSub, OutSubscriber, TextChangeListenerSub<OutSubscriber> >{

	private static final long serialVersionUID = 1L;
	
	private Logger log = LogManager.getLogger( AllRowsActionsUISub.class.getName() );
	
	
	public AllRowsActionsUISub( MSub mSub, Grid grid, In in, boolean allowDateFilters, boolean isHeader,
	...
	protected void addFilterField(BeanItemContainer<OutSubscriber> container,
		...
		TextChangeListenerSub<OutSubscriber> tChangeListener = getTextChangeListner( container, itemId, tF );
	...
	protected void setBeanItemContainer() {
		container = ((BeanItemContainer<OutSubscriber>) ((GeneratedPropertyContainer)  grid.getContainerDataSource())
				.getWrappedContainer());
	...
	protected TextChangeListenerSub<OutSubscriber> getTextChangeListner(
			BeanItemContainer<OutSubscriber> container, String itemId, TextField tF) {
			return new TextChangeListenerSub<OutSubscriber>( container, inTxn, itemId, tF );
	}
