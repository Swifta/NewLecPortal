...
public class AbstractMultiRowActionsUI extends VerticalLayout implements DUIControllable, PopupView.Content {
	...
	public AbstractMultiRowActionsUI( MTxn mTxn, In in, Grid grid, PopupView popupView ){
	...
	protected void attachBtnExport(){
		this.btnExport.addClickListener( new ClickListener(){
			...
			public void buttonClick(ClickEvent event) {
				...
				VerticalLayout v = new DataExportUITxn( mTxn, in, records, new VerticalLayout() ).getcMoreOps();
				v.setWidth( "37px" );
	...
	protected VerticalLayout getPopupViewContainer(){
		return this;
	}
