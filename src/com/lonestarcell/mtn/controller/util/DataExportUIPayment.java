...
public class DataExportUIPayment extends AbstractDDataExportUI<MTxn, OutTxn, In > implements DUIInitializable {

	private Logger log = LogManager.getLogger();
	public DataExportUIPayment( MTxn mTxn, In in, Collection<Item> records, VerticalLayout cMoreOps ){
	...
	protected  boolean setAllExportRecords( MTxn mTxn, In in, Collection<Item>records ){
		...
		Out out = mTxn.setExportDataMultiPaymentToday(in, container, records );
