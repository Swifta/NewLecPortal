...
import com.lonestarcell.mtn.controller.util.TokenPaginationUIController;
...
public class DTokenArchiveUI extends DTxnStateUIDesign implements DUserUIInitializable<DTokenUI, DTokenArchiveUI>, DUIControllable {
	...
	public void setHeader() {
		this.lbDataTitle.setValue( "ITRON Token Request" );
	...
	@Override
	public DTokenArchiveUI getParentUI() {
		return this;
	}

	@Override
	public void setParentUI(DTokenArchiveUI p) {
		// TODO Auto-generated method stub
	...
	public Grid loadGridData( BeanItemContainer<OutTxn> beanItemContainer ) {
		try {
			...
			TokenPaginationUIController pageC = new TokenPaginationUIController( beanItemContainer, mTxn, inTxn );;
	...
	private class AllRowsActionsUI extends DDateFilterUIDesign implements DUIControllable {
		...
		private TokenPaginationUIController pageC;
		
		private AllRowsActionsUI( Grid grid, In in, boolean allowDateFilters, TokenPaginationUIController pageC ){
			this.grid = grid;
			this.in = in;
