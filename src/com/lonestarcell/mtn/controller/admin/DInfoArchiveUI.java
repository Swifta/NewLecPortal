...
import com.lonestarcell.mtn.controller.util.InfoPaginationUIController;
...
public class DInfoArchiveUI extends DTxnStateUIDesign implements DUserUIInitializable<DInfoUI, DInfoArchiveUI>, DUIControllable {
	...
	public void setHeader() {
		this.lbDataTitle.setValue( "ITRON Customer Info & Token Retry" );
	...
	@Override
	public DInfoArchiveUI getParentUI() {
		return this;
	}

	@Override
	public void setParentUI(DInfoArchiveUI p) {
		// TODO Auto-generated method stub
	...
	public Grid loadGridData( BeanItemContainer<OutTxn> beanItemContainer ) {
		try {
			...
			mTxn.setInfoRetryToday(in, beanItemContainer );
			...
			InfoPaginationUIController pageC = new InfoPaginationUIController( beanItemContainer, mTxn, inTxn );
	...
	private class AllRowsActionsUI extends DDateFilterUIDesign implements DUIControllable {
		...
		private InfoPaginationUIController pageC;
		
		private AllRowsActionsUI( Grid grid, In in, boolean allowDateFilters, InfoPaginationUIController pageC ){
			this.grid = grid;
			this.in = in;
