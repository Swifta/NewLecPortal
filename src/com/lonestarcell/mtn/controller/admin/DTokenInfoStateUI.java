...
public class DTokenInfoStateUI extends DTxnStateUIDesign implements DUserUIInitializable<DTokenInfoUI, DTokenInfoStateUI>, DUIControllable {

	private static final long serialVersionUID = 1L;
	
	private DTokenInfoUI ancestor;
	...
	DTokenInfoStateUI( DTokenInfoUI a){
		init( a );
	}
	...
	@Override
	public void init(DTokenInfoUI a) {
	...
	@Override
	public DTokenInfoUI getAncestorUI() {
		return ancestor;
	}

	@Override
	public void setAncestorUI(DTokenInfoUI a) {
		this.ancestor = a;
		
	}

	@Override
	public DTokenInfoStateUI getParentUI() {
		return this;
	}

	@Override
	public void setParentUI(DTokenInfoStateUI p) {
		// TODO Auto-generated method stub
