...
public class DTxnArchiveUI extends DTxnStateUIDesign implements DUserUIInitializable<DTxnUI, DTxnArchiveUI>, DUIControllable {
	...
	@Override
	public DTxnArchiveUI getParentUI() {
		return this;
	}

	@Override
	public void setParentUI(DTxnArchiveUI p) {
		// TODO Auto-generated method stub
	...
	public Grid loadGridData( BeanItemContainer<OutTxn> beanItemContainer ) {
		try {
			...
			prepareGridHeader(grid, "statusDesc", "Status Desc", true );
