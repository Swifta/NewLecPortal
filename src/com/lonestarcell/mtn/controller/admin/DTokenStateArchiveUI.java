...
public class DTokenStateArchiveUI extends DTokenStateUI {

	private static final long serialVersionUID = 1L;
	
	private Logger log = LogManager.getLogger( DTokenStateArchiveUI.class.getName() );
	
	
	DTokenStateArchiveUI( DTokenUI a){
		super( );
